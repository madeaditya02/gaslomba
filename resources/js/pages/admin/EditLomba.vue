...
const form = useForm({
  nama_perlombaan: props.lomba.nama_perlombaan,
  kategori: props.lomba.kategori,
  pamflet_perlombaan: undefined,
  tempat_perlombaan: props.lomba.tempat_perlombaan,
  tanggal_mulai: props.lomba.tanggal[0],
  tanggal_selesai: props.lomba.tanggal[1],
  rekening: props.lomba.rekening,
  deskripsi: props.lomba.deskripsi,
  jumlah_cablom: props.lomba.cabang_lomba.length,
  nama_cablom: props.lomba.cabang_lomba.map(cablom => cablom.nama_cablom),
  tingkatan: props.lomba.cabang_lomba.map(cablom => cablom.tingkatan),
    ...
    <form @submit.prevent="form.transform(data => ({
        ...
        <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div class="sm:col-span-2">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3">
              <div>
                <Input v-model="form.tanggal_mulai" type="date" placeholder="Masukkan tanggal mulai" />
                <InputError :message="form.errors.tanggal_mulai" class="mt-1" />
              </div>
              <span>-</span>
              <div>
                <Input v-model="form.tanggal_selesai" type="date" placeholder="Masukkan tanggal seleatanggal_selesai" />
      ...
      <div class="">
        <div class="flex items-center gap-6 mb-6">
          ...
          <Button type="button" size="sm" @click="form.jumlah_cablom++; form.tingkatan.push([])">Tambah Cablom</Button>
        </div>
