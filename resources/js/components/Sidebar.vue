...
<template>
  <div
    ...
    <div class="mt-7">
      <h2 class="text-lg text-center">HIMAIF Udayana</h2>
      <hr class="h-0.5 bg-white mt-2">
    </div>
    <div class="mt-12 flex flex-col justify-between grow">
      <div>
        <Link href="/admin" class="inline-flex gap-3 items-center w-full mb-5.5 last:mb-0"
          :class="$page.url == '/admin' ? 'text-white' : 'text-white/50'">
        ...
        <Link href="/admin/lomba" class="inline-flex gap-3 items-center w-full mb-5.5 last:mb-0"
          :class="$page.url == '/admin' ? 'text-white' : 'text-white/50'">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
          <path fill-rule="evenodd"
